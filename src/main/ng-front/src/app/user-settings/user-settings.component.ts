...
@Component({
  ...
  imports: [MatCardModule, 
    ...
    MatInputModule,
    FormsModule, 
    MatButtonModule], // Add MatSelectModule and FormsModule to the imports array
  template: `
      <div class="settings-container">
        ...
        <!-- Preferences Section -->
        <mat-card appearance="raised">
          <mat-card-header>Preferences</mat-card-header>
          <mat-card-content>
        ...
        <mat-card appearance="raised">
          ...
          <mat-card-content>
            ...
            <button mat-button (click)="updateProfile()">Update Profile</button>
          </mat-card-content>
        </mat-card>
